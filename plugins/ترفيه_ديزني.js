...
export async function handler(m, { command, text, conn }) {
    ...
    let src = await (await fetch('https://gist.githubusercontent.com/owjdkdjxuwbnd/d2ef9658e653b2cbb219b38f5dfdc7c6/raw/07a0fd2e85de39d4a38cc65ebab8d145e1c52ce3/gistfile1.txt')).json();
