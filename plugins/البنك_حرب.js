const handler = async (m, {conn, isPrems}) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastPalestine < 600000) throw `*انــتـــظـر قــلـــيــلــا..⏱️* ⚔️\n\n*—◉    *الـعــــوده الــي الـــــحرب بــــعــد* ${msToTime(time - new Date())} ⏳*`;
  conn.sendMessage(m.chat, {text: `*أنـــت الــأن داخـل الــــحرب..⚔️*\n\n🏹 *${pickRandom(global.Palestine)}*\n\n*¡اكسب لي شجاعتك ${hasil} *بــيـــلـي*`}, {quoted: m});
