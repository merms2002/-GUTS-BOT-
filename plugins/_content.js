...
import fs from 'fs'
const { generateWAMessageFromContent, prepareWAMessageMedia, proto }  = ('baileys-pro')
import '../config.js'
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: ' 𝙏𝙀𝘽𝙍𝙊〔🔥〕𝘽𝙊𝙏 ', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
