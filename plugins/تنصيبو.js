...
➌ ﹝ادخل الكود الذي سيصلك من بوت 𝑀𝐸𝐺𝑂 𝙱𝙾َ𝚃﹞  
➍ ﹝انتظر حتى يتم الربط بنجاح وتأكيده﹞

⚠️ *تنبيه مهم:*  
✦ يجب استخدام *واتساب ماسنجر العادي* وليس واتساب الأعمال ❌

┗━〔 👨‍💻 تم التطوير بواسطة 𝑀𝐸𝐺𝑂 𝙳𝙴𝚅 〕━┛
> 𝑀𝐸𝐺𝑂 𝙱𝙾َ𝚃
> 𝙾𝚆𝙽𝙴𝚁 : 𝑀𝐸𝐺𝑂 𝙳𝙴𝚅
`.trim()
...
🤖 البوت:𝐷𝑅𝐴⇣²͢⁰͢²͢⁵⍣𝐺𝛩𝑁🐦‍🔥𝙱𝙾َ𝚃

➊ ﹝افتح الأجهزة المرتبطة في واتساب﹞  
➋ ﹝اختر "الربط بكود تحقق" من البوت الأساسي﹞  
➌ ﹝ادخل الكود الذي سيصلك من بوت 𝐷𝑅𝐴⇣²͢⁰͢²͢⁵⍣𝐺𝛩𝑁🐦‍🔥 𝙱𝙾َ𝚃﹞  
➍ ﹝انتظر حتى يتم الربط بنجاح وتأكيده﹞

⚠️ *تنبيه مهم:*  
✦ يجب استخدام *واتساب ماسنجر العادي* وليس واتساب الأعمال ❌

┗━〔 👨‍💻 تم التطوير بواسطه𝐿𝛩𝑺𝑇 𝑀𝐸𝑀𝛩𝑅𝑌 〕━┛  
